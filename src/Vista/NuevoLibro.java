...
public class NuevoLibro extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!txtPeriodo.getText().isEmpty()) {
            ...
            try {
                if(rs.next()){
                    ultimo = Integer.parseInt(rs.getString("n_libro"));
                }else{
                    ultimo = 1;
                }
                rs.close();
            ...
            c.Ejecutar("INSERT INTO librodiario ( n_libro , Periodo ) values ( '"+(ultimo + 1)+"','" + txtPeriodo.getText() + "')");
